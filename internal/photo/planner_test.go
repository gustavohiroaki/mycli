...
func TestBuildPlanWithGroupingUsesGroupedRename(t *testing.T) {
	...
	if filepath.Base(plan.Actions[0].DestPath) != "2026-05-24_10-00-00_canon-r6_b001.jpg" {
		t.Fatalf("first DestPath = %q", plan.Actions[0].DestPath)
	}
	if filepath.Base(plan.Actions[1].DestPath) != "2026-05-24_10-00-00_canon-r6_b001_1.jpg" {
