...
Quando origem e destino ja sao informados, o menu vem com defaults recomendados para biblioteca fotografica: estrutura por tipo/data/camera, `--rename grouped`, burst em `2s`, similaridade em `8` e duplicados separados.
